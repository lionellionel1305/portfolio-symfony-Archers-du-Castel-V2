 ...
 */
final class Version20250924135546 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE album ADD files JSON NOT NULL COMMENT \'(DC2Type:json)\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE album DROP files');
